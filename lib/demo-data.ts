...
export const demoRestaurants: Restaurant[] = [
  {
    ...
    address: "302 E Hopkins Ave, Aspen, CO", phone: "(970) 925-1007",
    description: "A compact Aspen favorite known for sandwiches, salads and a lively bar in a historic miner's cottage.",
    cuisines: ["american"], meals: ["lunch", "dinner"], priceLevel: 2,
    latitude: 39.1908, longitude: -106.8179,
    isAdvertiser: false,
    imageUrl: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=1400&q=80",
    openNow: true, verifiedAt: "2026-08-20", localVotes: 932, tags: ["burgers", "family-friendly"]
  },
  {
    ...
    cuisines: ["bakery", "coffee"], meals: ["breakfast", "lunch"], priceLevel: 1,
    latitude: 39.1897, longitude: -106.8172,
    isAdvertiser: false,
    imageUrl: "https://images.unsplash.com/photo-1509042239860-f550ce710b93?auto=format&fit=crop&w=1400&q=80",
    openNow: true, verifiedAt: "2026-08-18", localVotes: 771, tags: ["breakfast", "coffee", "family-friendly"]
  },
  {
    ...
    cuisines: ["italian", "pizza"], meals: ["lunch", "dinner"], priceLevel: 3,
    latitude: 39.1885, longitude: -106.8140,
    isAdvertiser: false,
    imageUrl: "https://images.unsplash.com/photo-1579751626657-72bc17010498?auto=format&fit=crop&w=1400&q=80",
    openNow: true, verifiedAt: "2026-08-22", localVotes: 640, tags: ["pizza", "italian", "outdoor-dining"]
  },
  {
    ...
    cuisines: ["japanese", "sushi"], meals: ["dinner"], priceLevel: 4,
    latitude: 39.2088, longitude: -106.9494,
    isAdvertiser: false,
    imageUrl: "https://images.unsplash.com/photo-1579871494447-9811cf80d66c?auto=format&fit=crop&w=1400&q=80",
    openNow: false, verifiedAt: "2026-08-17", localVotes: 488, tags: ["sushi"]
  },
  {
    ...
    cuisines: ["american"], meals: ["lunch", "dinner"], priceLevel: 3,
    latitude: 39.5471, longitude: -107.3248,
    isAdvertiser: false,
    imageUrl: "https://images.unsplash.com/photo-1515003197210-e0cd71810b5f?auto=format&fit=crop&w=1400&q=80",
    openNow: true, verifiedAt: "2026-08-21", localVotes: 584, tags: ["happy-hour"]
  },
  {
    ...
    cuisines: ["american", "coffee"], meals: ["breakfast", "lunch"], priceLevel: 2,
    latitude: 39.3998, longitude: -107.2103,
    isAdvertiser: false,
    imageUrl: "https://images.unsplash.com/photo-1550547660-d9450f859349?auto=format&fit=crop&w=1400&q=80",
    openNow: true, verifiedAt: "2026-08-19", localVotes: 415, tags: ["breakfast", "coffee"]
  },
  {
    ...
    cuisines: ["american", "pub"], meals: ["lunch", "dinner"], priceLevel: 2,
    latitude: 39.3686, longitude: -107.0322,
    isAdvertiser: false,
    imageUrl: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=1400&q=80",
    openNow: true, verifiedAt: "2026-08-16", localVotes: 363, tags: ["burgers", "happy-hour", "family-friendly"]
  },
  {
    ...
    cuisines: ["pizza", "italian"], meals: ["lunch", "dinner"], priceLevel: 1,
    latitude: 39.5340, longitude: -107.7834,
    isAdvertiser: false,
    imageUrl: "https://images.unsplash.com/photo-1574071318508-1cdbab80d002?auto=format&fit=crop&w=1400&q=80",
    openNow: true, verifiedAt: "2026-08-15", localVotes: 284, tags: ["pizza", "family-friendly"]
  }
];
...
export const demoPolls: Poll[] = [
  {
    id: "p1", slug: "best-burger-valley-2026", title: "Best Burger in the Valley",
    description: "One verified vote per person. Results update as votes are counted.",
    options: [
      { id: "o1", label: "White House Tavern", town: "aspen", votes: 1842 },
      { id: "o2", label: "Brick Pony Pub", town: "basalt", votes: 1366 },
      { id: "o3", label: "The Pullman", town: "glenwood-springs", votes: 921 }
    ]
  },
  {
    id: "p2", slug: "best-breakfast-2026", title: "Best Breakfast in the Valley",
    description: "Vote for the breakfast spot you would recommend to a neighbor.",
    options: [
      { id: "o4", label: "Paradise Bakery", town: "aspen", votes: 1278 },
      { id: "o5", label: "Silo", town: "carbondale", votes: 1164 }
    ]
  },
  {
    id: "p3", slug: "favorite-restaurant-valley-2026", title: "Favorite Restaurant in the Roaring Fork Valley",
    description: "Choose the one restaurant you would most recommend to a friend. One verified person gets one vote.",
    options: [
      { id: "o6", label: "White House Tavern", town: "aspen", votes: 2034, restaurantId: "r1" },
      { id: "o7", label: "Paradise Bakery", town: "aspen", votes: 1412, restaurantId: "r2" },
      { id: "o8", label: "Mezzaluna", town: "aspen", votes: 1138, restaurantId: "r3" },
      { id: "o9", label: "Sake", town: "aspen", votes: 966, restaurantId: "r4" },
      { id: "o10", label: "The Pullman", town: "glenwood-springs", votes: 1322, restaurantId: "r5" },
      { id: "o11", label: "Silo", town: "carbondale", votes: 1198, restaurantId: "r6" },
      { id: "o12", label: "Brick Pony Pub", town: "basalt", votes: 1046, restaurantId: "r7" }
    ]
  }
];
...
export const demoEvents: EventItem[] = [
  ...
  { id: "e2", title: "Community market", town: "carbondale", venue: "4th Street Plaza", startsAt: "2026-08-27T16:00:00-06:00", category: "community" },
  { id: "e3", title: "Trivia night", town: "glenwood-springs", venue: "Downtown", startsAt: "2026-08-27T19:00:00-06:00", category: "nightlife" }
];
...
export const demoBlogPosts: BlogPost[] = [
  {
    id: "b1",
    slug: "how-roaring-fork-local-will-cover-the-valley",
    title: "How Roaring Fork Local will cover the valley",
    ...
    authorName: "Roaring Fork Local",
    town: "aspen",
    publishedAt: "2026-08-26T09:00:00-06:00"
  },
  {
    id: "b2",
    slug: "send-us-your-local-suggestions",
    ...
    authorName: "Roaring Fork Local",
    publishedAt: "2026-08-26T08:00:00-06:00"
  }
];
